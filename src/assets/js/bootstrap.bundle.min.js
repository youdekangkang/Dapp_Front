...
!function (t, e) {
    ...
    class Te extends H {
        ...
        _getConfig(t) {
            if (t = {...this.constructor.Default, ...F.getDataAttributes(this._element), ...t}, r("dropdown", t, this.constructor.DefaultType), "object" == typeof t.reference && !s(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("dropdown".toUpperCase() + ': Option "public" provided type "object" without a required "getBoundingClientRect" method.');
            return t
        }
