  ...
  <div class="inner-banner inner-bg3">
    <div class="container">
      <div class="inner-title">
        <h3>Auction Bid Reveal Is Going On</h3>
        <ul>
          <li>
        ...
        <div v-for="product in products" :key="product.blockchainId" class="col-lg-4 col-md-6">
          <div class="auction-card">
            ...
            <div class="content">
              ...
              <a :href="'/product/' + product.blockchainId" class="place-btn">Place Bid</a>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    fetchProducts() {
      fetch('http://localhost:80/product/allProduct?productStatus=reveal')
